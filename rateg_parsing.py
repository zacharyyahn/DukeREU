...
non_aviation_ranks = {
    ...
    "1520":"Aerospace Maintenance Duty Officers",
    "8342":"F/A-18 Systems Organizational Maintenance Technician", 
    "7022":"Aviation Gasonline Handler",
    "AT":"Aviation Support", 
    "AF":"Aviation Support", 
    "ASAA":"Aviation Support", 
    "PR":"Parachute Rigger",
    "IT":"Informatio Technician",
    "LSSR":"Logistics Specialist",
    "LSSN":"Logistics Specialist",
    "IS":"Intelligence Specialist",
}

administrative = "LNC, IS3, MCCS, PSSN, MA2, CS1, ISSN, ITSR, YN2, YNSR, JO3, CTR, DK3, ACAN, SKC, PNSN, PC1, SKSA, MC3, IC, LS, YN, EO3, AG, AC, CTT, PS, MC2, LS2, LS3, MA3, PSCM, OS1, DC2, NC1, ITCM, CTT3, PS3, AGAR, SKSN, SK2, IT1, CTR2, IC3, SK3, IS1, CT, MA, EA, MC, SK, LN, AG3, IS2, PHAN, ITSN, IC1, SKSR, CTT2, PN2, OSSA, MA1, PCSN, AC1, IT2, ICC, YNSN, IC2, OS3, OSSN, AC2, SK1, CTTSN, ICFA, PN3, IT3, LISR, LISN, AC3, ACAR"

aircraft_upkeep = "AWSC, AWS2, AD1, ABF, AMEAN, AO2, AE1, ADAN, NA2, AME3, ATAN, AT3, AME2, AO1, ASAN, ABEAN, ADC, AMC, ADAA, AEC, AT1, AM2, AWF, ABE, AA, ABH1, AME, ABH2, AMAN, AMAA, AMAR, AE3, ABH, AW1, AW2, A03, AD, AT2, AB, AW3, AME1, AD3, AO, AT, AE, ABHC, AOC, ATC, AM1, AM3, ABHAA, AOAN, AD2, AEAN, AN, AR, ABHAN, ABH3, AE2, AECS, ABHAR, AW, AMAN, AK2, AOCM, AOC, ADCS, ADC, AA, ABHC, ADAR, AMEAA, AW2, AZ1, ASAR, AEAA, AG1, DCC, EMC, AR, ABH, AOCS, ABF2, AMAR, AT3, AE, PR, AK1, AW1, ATAA, AME, AZ, ABE, AO, AD, ABF, ASC, PR1, ATC, AME2, AZ2, AD3, AMEAN, AME3, AD1, ASAN, AT2, AMC, AM3, AE2, ABE1, ABE3, AOAN, AM2, ABH3, ABAN, AZAN, AD2, AM1, AO3, ABH1, ATAN, AS3, AS1, AEAN, ABE2, ABAA, AE3, PR3, PRAN, ABAR, AMEAR, AT1, ABF1, AZAA, AMEC, ADAA, AB1, AZ3, AMCS, AS2, AO2, ABH2, ABF3, AWAN, AEAR, ABFC, ADAN, AOAR, ABEC, AOAA, 1520, 8342, 7022, AWR2, AWRC, ABSN, ABHSN, ABECS, ABFSA, ABHSA, ABFSN, ABHCS, ABHSR, ABFSR, AT, AF, ASAA, PR" 

defense = "TM3, GM2, GMSR, GM3, TM2, GM, AM, TM1, GMSN, GMG, CTM, TM3, GMC, LSSR, LSSN, IS"

ship_maintenance =  "CTM3, CTR, CTR2, CTT2, ICFN, QMSA, MMFN, RM2, AM, FC3,  PR2, EM1, QMSA, ETSN, HTC, HT1, FCC, BMC, DCCS, HTFR, SHCS, MMCS, MR3, EN2, ETC, MMFR, QMSN, ENFA, ENFN, QMCS, EM, FC, EN, MM, QM, DC, SH, MR, FR, FN, SHSR, FCSN, HT, ETCS, EACN, STG1, ET3, MR2, MR1, DCFN, DCFR, ET1, BMSN, DC3, DCFA, HM1, MMFN, STG, MM3, BM3, GSE, FA, FT, AV, ET, SHSN, MM1, EM3, MM2, MMFA, SH3, BMSA, EM2, SH2, EN3, SHSA, FC2, EMFA, BM2, EMFN, QM3, ET2, HTFA, EN1, MMC, HTFN, DC1, HT3, IT"
...
def get_full_desc(rateg):
    try:
        RATEG = rateg.upper()
    except:
        RATEG=""
    if RATEG in aviation_ranks:
        return aviation_ranks[RATEG]
    elif RATEG in non_aviation_ranks:
        return non_aviation_ranks[RATEG]
    else:
        return "Unknown"

def get_division(rateg):
    try:
        RATEG = rateg.upper()
    except:
        RATEG=""
    if RATEG in administrative.split(", "):
        return "Administrative"
    elif RATEG in aircraft_upkeep.split(", "):
        return "Aircraft Upkeep"
    elif RATEG in defense.split(", "):
        return "Defense"
    elif RATEG in ship_maintenance.split(", "):
        return "Ship Upkeep"
    elif RATEG in personnel_maintenance.split(", "):
        return "Personnel Upkeep"
    else:
        return "Unknown"


data["Full Rank Description"] = data["RATEG"].apply(get_full_desc)
data["Full Rank Division"] = data["RATEG"].apply(get_division)

data.to_csv("exported_aviation.csv")